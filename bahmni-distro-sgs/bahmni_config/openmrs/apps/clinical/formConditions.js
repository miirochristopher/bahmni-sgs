Bahmni.ConceptSet.FormConditions.rules = {
    ...
    'Equipment Needed' : function (formName, formFieldValues) {
        var conditions = {show: [], hide: []};
        var selectedAnswer = formFieldValues['Equipment Needed'];
        if (selectedAnswer == 'Other') {
            conditions.show.push("Other Specify")
        } else {
	    // still in testing mode by default let it be visible"check file for testing"
            conditions.show.push("Other Specify")
        }
	return conditions;
    }
